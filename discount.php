...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="discountconn.php" method="POST">
        <div class="modal-body">
          <div class="form-group col-md-6">
            <label for="user" class="font-weight-bold">Select User</label>
              <?php
              $connection = mysqli_connect("localhost","root","");
              $db = mysqli_select_db($connection,'event management');

              $query = "SELECT * FROM system WHERE status='Active'";
              $query_run = mysqli_query($connection, $query);
              ?>
            <select name="user" class="form-control" required>
              <option value="" selected disabled>Select User From Here</option>
              <?php
              ...
              {
              ?>
              <option><?php echo $row['id'];?> <?php echo $row['username']; ?></option>
              <?php
                }
              }
              else
          ...
          <div class="form-group">
            ...
            <input type="number" name="price" class="form-control" placeholder="Enter Price3" required >                              
          </div><br>          
        </div>
...
<div class="main">
  <?php
    ...
    <?php endif ?>
  <h5 class="font-rubik text-center">Discount Management</h5>
  <div class="container">
      <div class="card">
        <div class="card-body bg-white shadow">
          <div class="row">
            <div class="col-md-12 text-end">
              <button class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#add">Add Amount</button>
            </div>
          </div>
          <br>          
          ...
          <h5 class="font-rubik text-center">Discount</h5>
          ...
          <?php
            ...
            $query = "SELECT * FROM discount LIMIT $start_from, $limit";
            $query_run = mysqli_query($connection, $query);
          ?>
